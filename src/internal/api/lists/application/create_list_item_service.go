...
func (s *CreateListItemService) CreateListItem(ctx context.Context, listID int32, title domain.ItemTitleValueObject, description domain.ItemDescriptionValueObject, userID int32) (*domain.ListItemRecord, error) {
