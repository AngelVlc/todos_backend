...
func (m *MockedListsRepository) FindList(ctx context.Context, list *domain.ListRecord) (*domain.ListRecord, error) {
...
func (m *MockedListsRepository) ExistsList(ctx context.Context, list *domain.ListRecord) (bool, error) {
	args := m.Called(ctx, list)
...
func (m *MockedListsRepository) GetAllListItems(ctx context.Context, listID int32, userID int32) ([]domain.ListItemRecord, error) {
	args := m.Called(ctx, listID, userID)
	if args.Get(0) == nil {
		return nil, args.Error(1)
	}
	return args.Get(0).([]domain.ListItemRecord), args.Error(1)
}

func (m *MockedListsRepository) FindListItemByID(ctx context.Context, itemID int32, listID int32, userID int32) (*domain.ListItemRecord, error) {
...
func (m *MockedListsRepository) FindListItem(ctx context.Context, listItem *domain.ListItemRecord) (*domain.ListItemRecord, error) {
...
func (m *MockedListsRepository) CreateListItem(ctx context.Context, listItem *domain.ListItemRecord) error {
	args := m.Called(ctx, listItem)
...
func (m *MockedListsRepository) UpdateListItem(ctx context.Context, listItem *domain.ListItemRecord) error {
	args := m.Called(ctx, listItem)

	return args.Error(0)
}

func (m *MockedListsRepository) BulkUpdateListItems(ctx context.Context, listItems []domain.ListItemRecord) error {
